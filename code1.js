...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(12740748);
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(12742876);
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(12747220);
}
}
if (isConditionTrue_0) {
...
{for(var i = 0, len = gdjs.GameCode.GDRespwanTopObjects2.length ;i < len;++i) {
    gdjs.GameCode.GDRespwanTopObjects2[i].getBehavior("ObjectSpawner").SpawnObject(gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDWallTopObjects2Objects, (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
}
}{for(var i = 0, len = gdjs.GameCode.GDRespwanBottomObjects2.length ;i < len;++i) {
    gdjs.GameCode.GDRespwanBottomObjects2[i].getBehavior("ObjectSpawner").SpawnObject(gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDWallBottomObjects2Objects, (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
}
...
isConditionTrue_1 = gdjs.evtsExt__RepeatEveryXSeconds__Repeat.func(runtimeScene, "Faster", 25, (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
if (isConditionTrue_1) {
isConditionTrue_1 = false;
...
{runtimeScene.getGame().getVariables().getFromIndex(0).add(32);
    ...
    gdjs.GameCode.GDRespwanTopObjects2[i].getBehavior("ObjectSpawner").SetSpawnPeriod(gdjs.evtTools.variable.getVariableNumber(runtimeScene.getGame().getVariables().getFromIndex(2)), (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
}
}{for(var i = 0, len = gdjs.GameCode.GDRespwanBottomObjects2.length ;i < len;++i) {
    gdjs.GameCode.GDRespwanBottomObjects2[i].getBehavior("ObjectSpawner").SetSpawnPeriod(gdjs.evtTools.variable.getVariableNumber(runtimeScene.getGame().getVariables().getFromIndex(2)), (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
}
}}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtsExt__RepeatEveryXSeconds__Repeat.func(runtimeScene, "Point", 60, (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
if (isConditionTrue_0) {
...
};gdjs.GameCode.asyncCallback12760188 = function (runtimeScene, asyncObjectsList) {
gdjs.GameCode.GDExitObjects3.length = 0;

gdjs.GameCode.GDRedoObjects3.length = 0;

{gdjs.evtTools.runtimeScene.setTimeScale(runtimeScene, 0);
}{gdjs.evtTools.object.createObjectOnScene((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : runtimeScene), gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDRedoObjects3Objects, 385, 300, "Restart");
}{gdjs.evtTools.object.createObjectOnScene((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : runtimeScene), gdjs.GameCode.mapOfGDgdjs_9546GameCode_9546GDExitObjects3Objects, 764, 24, "Restart");
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.4), (runtimeScene) => (gdjs.GameCode.asyncCallback12760188(runtimeScene, asyncObjectsList)));
}
}
...
{for(var i = 0, len = gdjs.GameCode.GDTimeObjects2.length ;i < len;++i) {
    gdjs.GameCode.GDTimeObjects2[i].getBehavior("Text").setText(gdjs.evtsExt__TimeFormatter__SecondsToHHMMSS.func(runtimeScene, gdjs.evtTools.runtimeScene.getTimeFromStartInSeconds(runtimeScene), (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)));
}
}}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(12756524);
}
}
if (isConditionTrue_0) {
...
/* Reuse gdjs.GameCode.GDPlayerObjects2 */
{runtimeScene.getGame().getVariables().getFromIndex(1).setString(gdjs.evtsExt__TimeFormatter__SecondsToHHMMSS.func(runtimeScene, gdjs.evtTools.runtimeScene.getTimeFromStartInSeconds(runtimeScene), (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)));
}{for(var i = 0, len = gdjs.GameCode.GDPlayerObjects2.length ;i < len;++i) {
    ...
    gdjs.GameCode.GDFlashObjects2[i].getBehavior("FlashTransitionPainter").PaintEffect("255;255;255", 0.01, "Flash", "Forward", 0, (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
}
}{gdjs.evtsExt__CameraShake__StartShaking.func(runtimeScene, 0.2, (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
}{gdjs.evtsExt__CameraShake__StopShaking.func(runtimeScene, 0.2, (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
}
{ //Subevents
...
for (var i = 0, k = 0, l = gdjs.GameCode.GDExitObjects3.length;i<l;++i) {
    if ( gdjs.GameCode.GDExitObjects3[i].getBehavior("ButtonFSM").IsClicked((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)) ) {
        isConditionTrue_1 = true;
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(12763980);
}
}
if (isConditionTrue_0) {
...
for (var i = 0, k = 0, l = gdjs.GameCode.GDRedoObjects1.length;i<l;++i) {
    if ( gdjs.GameCode.GDRedoObjects1[i].getBehavior("ButtonFSM").IsClicked((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)) ) {
        isConditionTrue_0 = true;
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(12764812);
}
}
if (isConditionTrue_0) {
